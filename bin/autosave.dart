...
final _backupDaily = Directory("${DungeonClubConfig.getDatabasePath()}/database_backup/daily");
final _backupWeeks = Directory("${DungeonClubConfig.getDatabasePath()}/database_backup/weeks");
