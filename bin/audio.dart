...
class MusicProvider {
  static final collection = PlaylistCollection(Directory('ambience'));

  static Future<void> loadMusicPlaylists() async {
...
class AmbienceState {
  ...
  void fromJson(Map<String, dynamic> json) {
    ...
    final pl = MusicProvider.collection.playlists.firstWhereOrNull(
